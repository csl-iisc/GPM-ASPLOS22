...
// 
// NOTICE: This file has been modified. The modifications are adding
// 'inline' for the functions, including mehcached_pow_approx,
// mehcached_zeta, mehcached_rand_d, mehcached_zipf_next.
